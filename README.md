...
- `googleSpreadsheetId` または `googleSpreadsheetUrl` の指定が正しいか確認してください。
...
### Q3. 補足情報は他の人にも見られちゃうの？

- いいえ、あなたが追加した補足情報は、あなたのブラウザーにだけ表示されます。
- Tampermonkeyが動作しているブラウザー、つまりあなた自身の画面表示を加工しているだけです。
